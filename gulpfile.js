...
const devURL = 'powertheme.local';
const themeDir = 'wp-content/themes/powertheme';

const path = {
    dist: themeDir + '/dist',
    sourcemaps: themeDir + '/sourcemaps/',
    php: themeDir + '/**/*.php',
    css: {
    ...
    js: {
        ...
        src: [
            themeDir + '/src/js/**/*.js',
            '!' + themeDir + '/src/js/admin/admin.js',
            '!' + themeDir + '/src/js/vendor/**'
        ],
        vendors: themeDir + '/src/js/vendor/**.js',
        admin: themeDir + '/src/js/admin/admin.js'
    }
};
